...
class DependencyGraph(object):
    ...
    def _parse(self, input_, cell_extractor=None, zero_based=False, cell_separator=None, top_relation_label='ROOT'):
        ...
        """
        def extract_collapsed_dep(cells, index):
            ele1, ele2 = cells
            rel, head_n = ele1.split('(')
            head, n = head_n.split('-')
            n=n[:-1]
            child_m, tail = ele2.split(')')
            word, m = child_m.split('-')
            return int(m), word, word, '','', '', int(n), rel
        ...
        for index, line in enumerate(lines, start=1):
            ...
            # print('cells', cells, cell_number, cell_separator, cell_extractor)
            ...
            try:
                ...
                word, lemma, ctag, tag, feats, head, rel = cell_extractor(cells, index)
